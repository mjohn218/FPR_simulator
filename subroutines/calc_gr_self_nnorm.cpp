...
//   }
	...
	double nafree = plist.Ntotalmol - 2.0 * (plist.Ntotalmol - plist.ntotalcomplex);
	double Nnorm = 1.0 * nafree * (nafree - 1) / 2.0;
	int pind;
	double Npair = 1.0 * plist.Ntotalmol * (plist.Ntotalmol - 1.0) / 2.0;
	j = 0;
	double tol = 1E-6;
