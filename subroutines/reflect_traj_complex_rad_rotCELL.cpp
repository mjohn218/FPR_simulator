...
//			cout<<"in: "<<traj[k][2]<<endl;
			traj[k][2] += 2.0 * ztot;
//			cout<<"out: "<<traj[k][2]<<endl;

		}
		/*ztot and ztot0 will always be different if rad does not equal zero*/
		// if (abs(ztot - ztot0) > tol) {
// 			cout << currz << "\t" << ind_com[k].zcom << "\t" << currz - ind_com[k].zcom << "\t" << traj[k][2] << endl;
// 			cout << "Different calculations of z bezond boz! " << ztot0 << " final: " << ztot << " molnum:" << p1 << endl;
