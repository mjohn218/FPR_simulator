...
void dissociate_sigmaPBC_com(int Ntotalmol, Fullmol *bases, Complex *ind_com, Parms &plist, int *p_home, int *i_home, int **Rlist, int *Nmyrxn, int **myrxn, double *bindrad, int *Ncoup, int **mycoupled, double irandmax, int &ndiss, int *disslist, int *ncross, double *kr, int it, int *ncrosscom, int *movestat)
{
